...
run_Musemory.py
================
MASTER RUNNER – Amazon Ads Campaign Rename & Upload Pipeline | Store: Musemory

Prefix tên Campaign: ASIN (ví dụ: B0XXXXXXXXX_SP02_AUTO_Nguyen)
...
Cách chạy:
    python run_Musemory.py                              # tự động tìm file
    python run_Musemory.py --bulk data/input/file.xlsx
    python run_Musemory.py --template path/to/tpl.xlsx
    python run_Musemory.py --no-csv                    # bỏ qua output CSV
    python run_Musemory.py --skip-merge                # chỉ chạy Bước 1-3
...
def run_pipeline(
    ...
    print()
    print("╔" + "═" * 68 + "╗")
    print("║     AMAZON ADS – MUSEMORY PIPELINE RUNNER (ASIN PREFIX)           ║")
    print("╠" + "═" * 68 + "╣")
