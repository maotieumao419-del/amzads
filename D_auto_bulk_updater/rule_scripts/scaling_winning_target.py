"""
scaling_winning_target.py  —  Rule Script
==========================================
Rule   : Scaling_Winning_Target
Trigger: clicks >= 5  AND  orders >= 3
Routing: flat (all match types)
Action : Bidding Adjustment — boost Top-of-Search placement by 25%
         to push rank on high-CVR keywords
"""
...
def execute(rule_config: dict, metrics: dict, match_type: str) -> list:
    ...
    try:
        pct = int(float(rule_config.get('set_percentage', 25)))
