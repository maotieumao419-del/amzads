"""
exact_match_relevance_drop.py  —  Rule Script
==============================================
Rule   : Exact_Match_Relevance_Drop
Trigger: impressions >= 2000  AND  clicks <= 3  AND  orders <= 0
Routing: match_type_logic → 'exact' only
Action : Pause — Exact match with extremely low CTR signals intent mismatch
"""
