"""
poor_cvr_underperformer.py  —  Rule Script
===========================================
Rule   : Poor_CVR_Underperformer
Trigger: clicks >= 25  AND  orders <= 1
Routing: flat (all match types)
Action : Pause — CVR ≤ 4%, listing underperforms versus competitors
"""
